  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      <header className="mb-10 flex flex-col items-center gap-6 text-center sm:flex-row sm:text-left">
        {portrait && (
          <div className="relative size-32 shrink-0 overflow-hidden rounded-full bg-secondary">
            <Image
              src={portrait}
              alt={page.titre}
              fill
        ...
        <div>
          ...
          {intro && <p className="mt-3 text-lg text-warm">{intro}</p>}
        </div>
      </header>
      ...
      {citation && (
        <blockquote className="mt-12 border-l-4 border-primary pl-4 text-xl font-medium italic text-foreground/80">
          « {citation} »
        </blockquote>
      )}
    </div>
