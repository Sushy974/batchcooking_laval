...
export function FormuleCard({ formule }: { formule: Formule }) {
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm text-muted">{formule.description}</p>
      ...
      <span className="mt-4 inline-flex w-fit rounded-full bg-brand/10 px-3 py-1 text-xs font-medium text-brand">
